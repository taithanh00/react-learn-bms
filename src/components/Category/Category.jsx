    ...
    <>
      <section>
        <div className="container">
          <div
            className="carousel__title grid place-items-center w-full mb-12"
            data-aos="flip-up"
          ...
          <div className="category w-full bg-[#ffffff] h-auto sm:grid sm:grid-cols-1 md:grid md:grid-cols-2 lg:grid lg:grid-cols-2 xl:grid xl:grid-cols-4 2xl:grid 2xl:grid-cols-4 gap-[21px] sm:pb-7">
            <div
              className=" bg-[#f1f3f2] lg:min-w-[321px] lg:min-h-[351px] justify-center items-center text-center sm:pb-7"
              data-aos="fade-up"
